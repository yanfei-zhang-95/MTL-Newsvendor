...
[opttheta, cost, exitflag, info] = minFunc( @(p) newsvendorCost_trace(p, net, XtrainB, lambda, gamma, beta), theta, options);
...
[optTrainErr,~] = newsvendorCost_trace(opttheta, net, XtrainB, lambda, gamma, beta);
%% Prediction
[~,test_]=size(Dtest);
