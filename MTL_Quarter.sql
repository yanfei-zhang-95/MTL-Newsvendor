...
DELIMITER $$
DROP TABLE IF EXISTS NVProductSales1997_2_Quarter;
...
BEGIN
	...
	CREATE TABLE NVProductSales1997_2_Quarter(
	ID int(11) NOT NULL AUTO_INCREMENT,
	QUARTER_OF_YEAR VARCHAR(255),
	PRODUCT_ID int(11),
	RECYCLE int(11),
	...
	REPEAT
		INSERT INTO NVproductSales1997_2_Quarter (QUARTER_OF_YEAR, PRODUCT_ID, TOTAL_UNIT_SALES) (
		SELECT Quarter_of_Year, Product_ID, sum(Unit_Sales) as total
...
UPDATE nvproductsales1997_2_Quarter
SET RECYCLE=(
SELECT Recy 
FROM nvproductlogs 
where nvproductlogs.ProductID=nvproductsales1997_2_Quarter.Product_ID);
...
select * from nvproductsales1997_2_Quarter;
...
DELIMITER $$
DROP TABLE IF EXISTS NVProductSales1998_2_Quarter;
...
BEGIN
	...
	CREATE TABLE NVProductSales1998_2_Quarter(
	ID int(11) NOT NULL AUTO_INCREMENT,
	QUARTER_OF_YEAR VARCHAR(255),
	PRODUCT_ID int(11),
	RECYCLE int(11),
	...
	REPEAT
		INSERT INTO NVproductSales1998_2_Quarter (QUARTER_OF_YEAR PRODUCT_ID, TOTAL_UNIT_SALES) (
		SELECT QUARTER_of_Year, Product_ID, sum(Unit_Sales) as total
...
UPDATE nvproductsales1998_2_Quarter 
SET RECYCLE=(
SELECT Recy 
FROM nvproductlogs 
where nvproductlogs.ProductID=nvproductsales1998_2_Quarter.Product_ID);
...
select * from nvproductsales1998_2_Quarter;