...
for i=1:(n - opts.prediction)
  ...
  switch l.type 
    ...
    case 'newsvendorloss01'
      res(i+1).x = nnnewsvendorloss01(res(i).x, l.demands, l.cp, l.ch, l.index);
...
if doder
  ...
  for i=n:-1:max(1, n-opts.backPropDepth+1)
    ...
    switch l.type
      ...
      case 'newsvendorloss01'
        res(i).dzdx = nnnewsvendorloss01(res(i).x, l.demands, l.cp, l.ch, l.index, res(i+1).dzdx);
      case 'newsvendorloss_l2'
